...
/*
       ...
       while (tamaño <= 7) {            
        ...
        int tamaño = 15;
        // ejecutarMetodos(tamaño);
        int[] arreglo = creadorArreglos.arregloQuemado(tamaño);
        int[] aleatorio = creadorArreglos.arregloAleatorio(tamaño);
       ...
       // System.out.println("Programción Dinamica ---  Arreglo Quemado");
        //System.out.println(metodoDinamico.aplicarMetodoDinamico(0, 0, arreglo, tamaño) - 1);
        System.out.println("Programción Dinamica ---  Arreglo Aleatorio");
        System.out.println(metodoDinamico.aplicarMetodoDinamico(0, 0, aleatorio, tamaño) - 1);
        System.out.println("--------------------------------------------------------------------------");
